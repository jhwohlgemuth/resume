...
\tightlist
\item
  \emph{(Experienced)} Rust, PowerShell, Python, C\#, F\#, ECMAScript
  (JavaScript), Node.js, HTML/XML/CSS
\item
  \emph{(Familiar)} WebAssembly, Julia, ReasonML, Clojure,
  ClojureScript, Kotlin, Elm, R
\end{itemize}
...
\tightlist
\item
  Work closely with senior R\&D professionals, providing impactful
  machine learning engineering and advanced analytical contributions to
  the conceptualization and design of new approaches that solve pressing
  national security challenges.
\item
  Provide coding support to implement new algorithms as proof of concept
  or prototype to test effectiveness and scalability of the proposed
  solutions.
\item
  Work in a highly collaborative environment with data scientists,
  machine learning scientists, remote sensing scientists, engineers,
  physicists and geographers to deliver systems from prototyping to
  production level.
\end{itemize}
...
\tightlist
\item
  Contributor to the DoD
  \href{https://community.apan.org/wg/adept-framework/}{Artificial
  Intelligence Design Engineering for People and Technology (ADEPT)}
  framework.
\item
...
\item
  ...
  \hyperref[publications-citations]{publications section}.
\item
