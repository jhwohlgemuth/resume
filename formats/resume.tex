...
\item
  \emph{(Experienced)} ECMAScript (JavaScript), node.js/CommonJS,
  Python, HTML5/CSS3, XML, LaTeX, ActionScript
\item
...
\hyperdef{}{certifications}{\section{CERTIFICATIONS}\label{certifications}}
