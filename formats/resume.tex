...
\tightlist
\item
  \emph{(Experienced)} PowerShell, Python, C\#, F\#, ECMAScript
  (JavaScript), Node.js, HTML/XML/CSS
\item
  \emph{(Familiar)} Julia, Rust, ReasonML, Clojure, ClojureScript,
...
\hypertarget{present-geospatial-data-scientist}{%
...
\hypertarget{operations-research-analyst-data-scientist}{%
