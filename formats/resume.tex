...
\item
  \emph{(Familiar)} Rust, Kotlin, Clojure, ClojureScript, Elm, ML
  (Reason, OCaml, F\#), Python
\end{itemize}

\begin{quote}
I believe understanding math and functional programming are essential in
order to excel at writing sustainable software.
\end{quote}
...
\item
  flow, jest, ESLint
\item
  I pretty much am familiar with everything\ldots{}not that I am a
  master of everything, but that I have at least tried everything and
  understand the purpose all items in the ecosystem.
\end{itemize}
...
\begin{quote}
I keep track of current trends and developments\ldots{}it is kind of a
hobby
\end{quote}
